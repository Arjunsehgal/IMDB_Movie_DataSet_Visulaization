...
IMDB_Movies <- read_csv("C:\\Users\\arjun sehgal\\Desktop\\IMDb-movie-dataset-project-main\\movie_metadata.csv")
View(IMDB_Movies)
head(IMDB_Movies)
summary(IMDB_Movies)
...
library(reshape)
break_genre <- colsplit(IMDB_Movies$genres,split="\\|",name=c("n1","n2","n3","n4","n5","n6","n7","n8"))
...
#   Accuracy is 0.5611 for test set. in refression tree
